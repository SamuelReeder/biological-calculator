...
public class AllModelsForView extends javax.swing.JFrame {
    ...
    public GeneticMaterialModel aGeneticMaterialModel = new GeneticMaterialModel();

    public static cs20viewcontroller.ViewUserActions mainFrame;
    public static Container mainContentPane;

    public static screen2.ViewUserActions screen2 = new screen2.ViewUserActions();

    public static void goToScreen(int screen) {
        if (screen == 2) {
            AllModelsForView.mainFrame.setContentPane(AllModelsForView.screen2.getContentPane());
